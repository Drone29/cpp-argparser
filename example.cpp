...
//            .SetParameters("int")
     ...
     *
     *  Can be called only by m_key without parameters: '-x', '-b', '--bool', etc.
     *
    ...
    parser.addArgument<bool>("-b", "--bool").Finalize()
    ...
    parser.addArgument<int>("--variadic", "-var").Finalize()
            ...
            .help("nargs(1, -1, \"N\") parses any number of integers. Result is std::vector<int>");
    ...
    parser.addArgument<CL>("struct")
            ...
            .SetCallable(createStruct).Finalize()
